...
\begin{description}
  ...
  \skill{Climbing} Allows you to climb walls, cliffs and other obstacles. It helps with finding the right footing while doing so. Uses \emph{Strength} and
  \emph{Constitution}.
  ...
  \skill{Mechanics} Mechanics allows you to pop open a hood of a car and instantly recognise why it won't start. It involves repairs and maintenance for machines
  ...
  \skill{Medicine (Bionics) (Speciality)} This skill allows you to install, repair and maintain installed bionics.
