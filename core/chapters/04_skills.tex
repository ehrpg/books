...
\begin{description}
  \skill{Acrobatics} With acrobatics you can perform such acts as rope
  ...
  \skill{Climbing} Allows you to climb walls, cliffs and other obstacles. It
  helps with finding the right footing while doing so. Uses \emph{Strength}
  and \emph{Constitution}.

  \skill{Dodging} A basic combat skill to move out of harm's way. It can be
  ...
  \skill{Engineering (Any) (Special)} You have studied the art of applying
  ...
  \skill{First Aid} First aid comprises techniques ranging from applying
  ...
  \skill{Intrusion} This skill covers everything from breaking and entering,
  ...
  \skill{Light Weapons} This skill grants training in man portable military
  ...
  \skill{Mechanics} Mechanics allows you to pop open a hood of a car and
  ...
  \skill{Medicine (Bionics) (Speciality)} This skill allows you to install,
  ...
  \skill{Medicine (Trauma Care) (Speciality)} Trauma care specialises in treating
  ...
  \skill{Blades (Melee Combat)} Bladed weapons include everything that have a
  ...
  \skill{Unarmed (Melee Combat)} The hard of unarmed hand-to-hand combat.

  \skill{Micro Gravity} Allows manoeuvring in micro gravity environments. Uses
  ...
  \skill{Oratory} The art of, lying, intimidating, and giving threats as well
  as giving motivational speeches. It uses \emph{Intelligence} and \emph{Charisma}.

  \skill{Oratory (Intimidate) (Speciality)} Intimidate allows you to strike
  fear into the heart of others. Uses \emph{Strength} and \emph{Charisma}.

  \skill{Oratory (Smooth Talking) (Speciality)} The art of lying convincingly,
  ...
  \skill{Pilot Spacecraft (Special)} This special skill allows you to pilot all
  ...
  \skill{Questioning} The opposite skill to Oratory. The art of interrogating,
  ...
  \skill{Radio Operations} This skill allows you to operate radio signal
  ...
  \skill{Science (Any) (Special)} You are educated and trained one of the
  ...
  \skill{Small Arms} The small arms skill allows a character to aim, shoot,
  ...
  \skill{Small Unit Tactics} This skill includes everything a soldier needs to
